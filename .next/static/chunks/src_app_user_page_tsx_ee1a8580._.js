                ...
                "UserPage.useEffect.fetchOrders": async ()=>{
                    try {
                        ...
                        if (res.ok) {
                            ...
                            const formattedOrders = rawData.map({
                                "UserPage.useEffect.fetchOrders.formattedOrders": (order)=>{
                                    const items = order.items.map({
                                        "UserPage.useEffect.fetchOrders.formattedOrders.items": (item)=>{
                                    ...
                                    }["UserPage.useEffect.fetchOrders.formattedOrders.items"]);
                                    return {
                                        id: order.id,
                            ...
                            }["UserPage.useEffect.fetchOrders.formattedOrders"]);
                            // Sort newest first
