...
function ProductPage() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "ProductPage.useEffect": ()=>{
            setLoading(true);
            setError(null);
            fetch("http://localhost:8080/wallpapers/".concat(slug)).then({
                ...
                "ProductPage.useEffect": (err)=>setError(err.message || "Failed to fetch product")
...
_s(ProductPage, "Dvy1xYePk8D+uNGuc1cGvEnFzg8=", false, function() {
    return [
...
//# sourceMappingURL=_9ee318be._.js.map